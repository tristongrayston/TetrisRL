...
from geneticAlgorithm import randomPlayer
...
class Tetris(object):
    ...
    def make_action(self, player, current_piece, grid):
    ...
    def main(self, win):
        ...
        while run:
            ...
            #Fundamental problem:
            # I need to create a piece of code that gets an event to play on a timed interval.
            if fall_time/1000 > fall_speed:
                ...
                if not(self.valid_space(current_piece, grid)) and current_piece.y > 0:
                    current_piece.y -= 1
                    change_piece = True
            pygame.time.set_timer(newevent, 250)
...
if __name__ == "__main__":
    ...
    #Process(target=decision_loop).start()
    #Process(target=play_tetris.main_menu()).start()
